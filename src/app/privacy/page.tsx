...
export default async function PrivacyPage() {
  ...
  try {
    ...
    console.log('Privacy: Loaded from DB. Business name:', config.businessName);
  } catch (error) {
    console.error('Privacy: Direct DB failed, trying API fallback:', error);
    try {
      ...
      console.error('Privacy: API fallback also failed:', apiError);
      config = null;
    }
  }
